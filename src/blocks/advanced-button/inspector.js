...
const { ResRangleControl, AlignmentControl, ColorControl, TabPanelControl } =
	Controls;
		...
		<InspectorControls>
			...
			>
				...
				<RangeControl
					...
					value={ btnBorder }
					onChange={ ( border ) =>
						setAttributes( { btnBorder: border } )
					}
					min={ 0 }
					max={ 10 }
				/>
